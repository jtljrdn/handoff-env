...
The CLI is free on every plan. Free organizations can hold up to **3 active CI/CD tokens** at a time, enough for one or two pipelines. Team is unlimited. If you hit the cap, revoke an unused token from the [API keys page](/organization/api-keys) or upgrade on the [pricing page](/pricing).
