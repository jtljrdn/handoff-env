...
- **End-to-end encrypted.** Values are sealed on your device before they reach us; our servers only see ciphertext. See [the security model](/docs/security/model) for specifics.
